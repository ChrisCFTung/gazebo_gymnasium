...
class GazeboConnection():
    ...
    def model_config(self, model_name:str, pose=[0.0, 0.0, 0.0, 0.0], 
        ...
        gzmodel.pose.position.y = pose[1]
        gzmodel.pose.position.z = pose[2]
        gzmodel.pose.orientation.x = orientation[0]
        gzmodel.pose.orientation.y = orientation[1]
        gzmodel.pose.orientation.z = orientation[2]
        gzmodel.pose.orientation.w = orientation[3]
